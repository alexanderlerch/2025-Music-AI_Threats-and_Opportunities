...
%\begin{frame}{musical communication}{musical communication and AI}
      %\vspace{-3mm}
        %\begin{figure}
                %\centering
                %\begin{picture}(140,35)
...
\begin{frame}{musical communication}{paradigm shift}
    \vspace{-5mm}
    \begin{columns}
    \column{.65\linewidth}
    ...
    \column{.35\linewidth}
        ...
        %\vspace{20mm}
        \begin{figure}%
            \includegraphics[width=\columnwidth]{responsible-ai}%
        \end{figure}
    \end{columns}
\end{frame}
